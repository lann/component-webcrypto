...
export const EXPECTED = {
  ...
  "import_export/symmetric_importKey (HMAC, AES-GCM)": { inPassed: 78, inFailed: 0, outPassed: 0, outFailed: 282 },
  "generateKey/successes (HMAC, AES-GCM)": { inPassed: 21, inFailed: 0, outPassed: 0, outFailed: 459 },
};
