/** @module Interface lann:webcrypto/aes-ctr@0.1.0 **/
...
export function unwrapKeyJwk(variant: AesVariant, input: UnwrapInput, options: CipherKeyOptions): Promise<CipherKey>;
