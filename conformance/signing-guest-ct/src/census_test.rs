...
//! `conformance-signing-guest`'s final `tests.lock`, its inventory frozen
//! at the M1.6 cutover; the incumbent itself is deleted) exactly — the
//! decline cases and any post-cutover generator rows are additive and
