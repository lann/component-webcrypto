...
pub async fn import_key(raw_material: Vec<u8>, options: AeadKeyOptions) -> Result<Aead, Error> {
    Ok(Aead::from_raw(
        bindings::xchacha20_poly1305::import_key(raw_material, options.lower()).await?,
    ))
}
