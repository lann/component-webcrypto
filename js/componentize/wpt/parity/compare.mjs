...
// losses.js re-records via `just update-wpt-parity`; losses-<engine>.js via
// `just update-wpt-parity-<engine>`.
const UPDATE_RECIPE = `update-wpt-parity${basename(lossesFile, ".js").slice("losses".length)}`;
...
// \`group :: test name\`. Generated by \`just ${UPDATE_RECIPE}\`; compare.mjs
