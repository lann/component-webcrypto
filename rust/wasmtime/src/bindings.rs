...
mod generated {
    wasmtime::component::bindgen!({
        ...
        imports: {
            ...
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.algorithm-name": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.algorithm-length": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.iv-size": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.extractable": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.can-encrypt": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.can-decrypt": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.can-wrap": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key.can-unwrap": trappable,
            "lann:webcrypto/cipher@0.1.0.[constructor]cipher-key-options": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key-options.can-encrypt": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key-options.can-decrypt": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key-options.can-wrap": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key-options.can-unwrap": trappable,
            "lann:webcrypto/cipher@0.1.0.[method]cipher-key-options.extractable": trappable,
            ...
            "lann:webcrypto/signature@0.1.0.[method]verifying-key.algorithm-length": trappable,
            "lann:webcrypto/signature@0.1.0.[method]verifying-key.algorithm-public-exponent": trappable,
            ...
            "lann:webcrypto/signature@0.1.0.[method]signing-key.algorithm-length": trappable,
            "lann:webcrypto/signature@0.1.0.[method]signing-key.algorithm-public-exponent": trappable,
            ...
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key.algorithm-name": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key.algorithm-length": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key.extractable": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key.can-wrap": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key.can-unwrap": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[constructor]kw-key-options": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key-options.can-wrap": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key-options.can-unwrap": trappable,
            "lann:webcrypto/key-wrap@0.1.0.[method]kw-key-options.extractable": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[constructor]decryption-key-options": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key-options.can-decrypt": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key-options.can-unwrap": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key-options.extractable": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]encryption-key.algorithm-name": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]encryption-key.algorithm-hash": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]encryption-key.algorithm-length": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]encryption-key.algorithm-public-exponent": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.algorithm-name": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.algorithm-hash": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.algorithm-length": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.algorithm-public-exponent": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.can-decrypt": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.can-unwrap": trappable,
            "lann:webcrypto/public-encryption@0.1.0.[method]decryption-key.extractable": trappable,
        },
        with: {
            ...
            "lann:webcrypto/wrapping.wrap-input": crate::WrapInput,
            "lann:webcrypto/wrapping.unwrap-input": crate::UnwrapInput,
            "lann:webcrypto/key-wrap.kw-key": crate::KwKey,
            "lann:webcrypto/key-wrap.kw-key-options": crate::KwKeyOptions,
            ...
            "lann:webcrypto/cipher.cipher-key": crate::CipherKey,
            "lann:webcrypto/cipher.cipher-key-options": crate::CipherKeyOptions,
            ...
            "lann:webcrypto/public-encryption.encryption-key": crate::EncryptionKey,
            "lann:webcrypto/public-encryption.decryption-key": crate::DecryptionKey,
            "lann:webcrypto/public-encryption.decryption-key-options": crate::DecryptionKeyOptions,
        },
    });
}
