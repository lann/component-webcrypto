...
mod generated {
    wasmtime::component::bindgen!({
        ...
        with: {
            "lann:webcrypto/mac.mac-key": crate::retained::MacKey,
            "lann:webcrypto/mac.mac-key-options": crate::retained::MacKeyOptions,
            "lann:webcrypto/derivation.derive-options": crate::retained::DeriveOptions,
            "lann:webcrypto/derivation.derive-input": crate::retained::DeriveInput,
            "lann:webcrypto/hkdf.ikm": crate::retained::Ikm,
            "lann:webcrypto/pbkdf2.password": crate::retained::Password,
            "lann:webcrypto/key-agreement.agreement-key-options": crate::retained::AgreementKeyOptions,
            "lann:webcrypto/key-agreement.public-key": crate::retained::AgreementPublicKey,
            "lann:webcrypto/key-agreement.secret-key": crate::retained::AgreementSecretKey,
            "lann:webcrypto/aead.aead-key-options": crate::retained::AeadKeyOptions,
            "lann:webcrypto/aead-internal-nonce.internal-nonce-key-options": crate::retained::InternalNonceKeyOptions,
            "lann:webcrypto/signature.signing-key-options": crate::retained::SigningKeyOptions,
            "lann:webcrypto/aead.aead-key": crate::retained::AeadKey,
            "lann:webcrypto/cipher.cipher-key": crate::retained::CipherKey,
            "lann:webcrypto/cipher.cipher-key-options": crate::retained::CipherKeyOptions,
            "lann:webcrypto/aead-internal-nonce.internal-nonce-key": crate::retained::InternalNonceKey,
            "lann:webcrypto/digest.digest": crate::retained::Digest,
            "lann:webcrypto/signature.verifying-key": crate::retained::VerifyingKey,
            "lann:webcrypto/signature.signing-key": crate::retained::SigningKey,
        },
    });
}
